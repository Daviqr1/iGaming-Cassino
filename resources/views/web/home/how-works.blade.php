...
@section('content')
    <div class="container">
        ...
        <div class="page__content">
            ...
            <div class="how-works">
                <h2 class="mt-5">Perguntas frequentes - {{ getenv('APP_NAME') }}</h2>
                ...
                <div class="mt-4">
                    ...
                    <p>Jogar nos cassinos oferecidos pelo <strong>{{ getenv('APP_NAME') }}</strong> requer uma conta no site. Se você ainda não tem uma, basta clicar no botão "Inscrever-se" na página de Apostas e seguir o processo de registro.</p>
