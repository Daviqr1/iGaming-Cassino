    ...
    <div class="container">
        ...
        <div class="page__content">
            ...
            <div class="about-us-description">
                ...
                <p>
                    Bem-vindo à <strong>{{ getenv('APP_NAME') }}</strong>: sua porta de entrada para um mundo emocionante de entretenimento e apostas online!
                ...
                <p>
                    Além dos jogos de slot, na <strong>{{ getenv('APP_NAME') }}</strong>, os amantes do futebol encontram um espaço especial para suas apostas. Apostar em jogos de futebol nunca foi tão fácil e emocionante.
                ...
                <p>
                    O grande diferencial da <strong>{{ getenv('APP_NAME') }}</strong> é o nosso sistema de apostas, projetado para proporcionar uma experiência fácil e sem complicações. Valorizamos a simplicidade, sem sacrificar a
                ...
                <p>
                    Na <strong>{{ getenv('APP_NAME') }}</strong>, acreditamos que a diversão é a chave para uma experiência de cassino online memorável. Venha se juntar a nós e descubra o emocionante mundo dos jogos
